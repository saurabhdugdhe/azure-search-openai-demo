                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <SparkleFilled fontSize={"120px"} primaryFill={"rgba(197, 2, 50, 1)"} aria-hidden="true" aria-label="Chat logo" />
                            <h1 className={styles.chatEmptyStateTitle}>Rockwell PlantPAxAI</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Ask anything about your devices</h2>
